...
/**
 *******************************************************************************
 ** \addtogroup Trim Common Functions
 ******************************************************************************/
//@{
...
boolean_t Trim_GetIntFlag(en_trim_inttype_t enIntType)
{
    ...
    switch (enIntType)
    {
        ...
        case CalCntOf: 
            ...
            break;    
        case XTAL32KFault: 
            bRetVal = M0P_CLK_TRIM->IFR_f.XTAL32K_FAULT ? TRUE : FALSE;
            break;    
        case XTAL32MFault: 
            bRetVal = M0P_CLK_TRIM->IFR_f.XTAL32M_FAULT ? TRUE : FALSE;
            break;    
        default:
            bRetVal = FALSE;
            break;
...
en_result_t Trim_ClearIntFlag(en_trim_inttype_t enIntType)
{
    ...
    {
        case RefStop:
            M0P_CLK_TRIM->ICLR_f.STOP_CLR = FALSE;
            enResult = Ok;
            break;    
        case CalCntOf:
            M0P_CLK_TRIM->ICLR_f.CALCNT_OF_CLR = FALSE;
            enResult = Ok;
            break;    
        case XTAL32KFault:
            M0P_CLK_TRIM->ICLR_f.XTAL32K_FAULT_CLR = FALSE;
            enResult = Ok;
            break;    
        case XTAL32MFault: 
            M0P_CLK_TRIM->ICLR_f.XTAL32M_FAULT_CLR = FALSE;
            enResult = Ok;
            break;    
        default:
            enResult = Error;
