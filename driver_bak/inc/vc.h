...
{
    VcFilter6us,            ///< 输出滤波时间6us
    VcFilter12us,           ///< 输出滤波时间12us
    VcFilter25us,           ///< 输出滤波时间25us
    VcFilter100us,          ///< 输出滤波时间100us
    VcFilter400us,          ///< 输出滤波时间400us
    VcFilter1200us,         ///< 输出滤波时间1.2ms
    VcFilter5ms,            ///< 输出滤波时间5ms
    VcFilter20ms,           ///< 输出滤波时间20ms
}en_vc_resp_filter_t;
...
{
    VcDivVrefAvcc,              ///< AVCC
    VcDivVrefAdc,               ///< ADC Ref (ADC CR0 SREF)
}en_vc_div_vref_t;
