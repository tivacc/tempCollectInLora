...
** History:
**
**   - 2017-06-16  0.1   First version for Device Driver Library of Module.
**
******************************************************************************/
...
} stc_bgr_pmu_cr_field_t;

typedef struct
{
    __IO uint32_t BGR_TRIM                  : 6;
    __IO uint32_t BGR_TEST                  : 1;
} stc_bgr_bgr_option_field_t;
...
typedef struct
{
    ...
    union
    {
        __IO uint32_t PMU_CR;
        stc_bgr_pmu_cr_field_t PMU_CR_f;
    };
    union
    {
        __IO uint32_t BGR_OPTION;
        stc_bgr_bgr_option_field_t BGR_OPTION_f;
    };
}M0P_BGR_TypeDef;
